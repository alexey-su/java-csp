...
public final class XMLDSigRI extends Provider {
    ...
    public XMLDSigRI() {
        ...
        super("CSPXMLDSig", 1.00, INFO);

        final Map<Object, Object> map = new HashMap<Object, Object>();
        map.put("XMLSignatureFactory.DOM",
                "org.company.security.csp.xml.dsig.internal.dom.DOMXMLSignatureFactory");
        map.put("KeyInfoFactory.DOM",
                "org.company.security.csp.xml.dsig.internal.dom.DOMKeyInfoFactory");


        // Inclusive C14N
        map.put("TransformService." + CanonicalizationMethod.INCLUSIVE,
                "org.company.security.csp.xml.dsig.internal.dom.DOMCanonicalXMLC14NMethod");
        ...
        map.put("TransformService.http://www.w3.org/2006/12/xml-c14n11",
                "org.company.security.csp.xml.dsig.internal.dom.DOMCanonicalXMLC14N11Method");
        map.put("TransformService.http://www.w3.org/2006/12/xml-c14n11" +
                " MechanismType", "DOM");
        ...
        map.put("TransformService." + CanonicalizationMethod.EXCLUSIVE,
                "org.company.security.csp.xml.dsig.internal.dom.DOMExcC14NMethod");
        ...
        map.put("TransformService." + Transform.BASE64,
                "org.company.security.csp.xml.dsig.internal.dom.DOMBase64Transform");
        ...
        map.put("TransformService." + Transform.ENVELOPED,
                "org.company.security.csp.xml.dsig.internal.dom.DOMEnvelopedTransform");
        ...
        map.put("TransformService." + Transform.XPATH2,
                "org.company.security.csp.xml.dsig.internal.dom.DOMXPathFilter2Transform");
        ...
        map.put("TransformService." + Transform.XPATH,
                "org.company.security.csp.xml.dsig.internal.dom.DOMXPathTransform");
        ...
        map.put("TransformService." + Transform.XSLT,
                "org.company.security.csp.xml.dsig.internal.dom.DOMXSLTTransform");
