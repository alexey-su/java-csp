 ...
 */
package org.company.security.csp.ws.security.action;
 ...
 * <br/>Вместо создания WSSecSignature создается LocalWSSecSignature.
 * 
...
public class LocalSignatureAction implements Action {
	...
	protected LocalWSSecSignature loadWSSecSignature(RequestData reqData) {
		LocalWSSecSignature wsSign = new LocalWSSecSignature(reqData.getWssConfig());
		return wsSign;
	}
